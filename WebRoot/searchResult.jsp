...
<body>
    <div style='background-color:#4682B4;width:100%;height:50px;color:#FFFFFF;font-family:微软雅黑 '>
		<p style='font-size:25px;text-align:center;line-height:50px;'>搜索结果
		</p>
	</div>
	<!-- 规则等介绍 -->
	...
	<% //这里写从数据库查询拍品信息的语句
		...
		if(searchKey==null)
			searchKey="";
		List<SimpleAuctionInfo> auctionList = DBHelper.getSearchResult(searchKey);
	...
	%>
		<div style='background-color:#FFFFFF; border:2px dashed #4682B4  ; font-family:微软雅黑  '>
			<p>没有搜索到任何结果!</p>
			<p><a href='upload.jsp'><button>我来提交一个拍品!</button></a></p>
		</div>
	<%
		}else{
