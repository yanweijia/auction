...
<body>
	...
	<div style='background-color:#FFFFFF;align:center; border:2px dashed #4682B4  ; font-family:微软雅黑'>
		<br/>
		<form target='_blank' method='POST' action='deleteResult.jsp'>
			<table style='width:100%;height:110px;background-color:#FFFFFF'>
				
				<tr align="center"  height=35 >
					<td>请输入该拍品的管理密码 </td>
					<td><input name='password' type='password'  placeholder='拍品管理密码'></td>
				</tr>
				<tr align="center" height=35 >
					<td colspan="2"> <button type="submit">确　认</button></td>
				</tr>
				<tr align="center" height=35 >
					<td colspan="2"><input name='auction_id' type="hidden" value='<%=auction_id%>'/></td>
				</tr>
			</table>
		</form>
	</div>
