...
<body>
    <div style='background-color:#4682B4;width:100%;height:50px;color:#FFFFFF;font-family:微软雅黑 '>
		<p style='font-size:25px;text-align:center;line-height:50px;'>拍品搜索
		</p>
	</div>
	<!-- 规则等介绍 -->
	...
	<div style='background-color:#FFFFFF;align:center; border:2px dashed #4682B4  ; font-family:微软雅黑'>
		<br/>
		<form target='_blank' method='GET' action='searchResult.jsp'>
			<table style='width:100%;height:110px;background-color:#FFFFFF'>
				<tr align="center"  height=35 >
					<td>搜索关键字 </td>
					<td><input name='searchKey' type='text'  placeholder='输入关键词(匹配拍品名称或介绍)'></td>
				</tr>											
				<tr align="center" height=35 >
					<td colspan="2"> <button type="submit">搜　索</button></td>
				</tr>
			</table>
		</form>
	</div>
